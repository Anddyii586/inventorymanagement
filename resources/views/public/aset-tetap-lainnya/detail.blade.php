...
<head>
    ...
    <title>Detail Aset Tetap Lainnya - {{ $asetTetapLainnya->id }}</title>
                ...
                <div class="flex flex-col sm:flex-row items-center sm:items-start justify-between space-y-4 sm:space-y-0">
                    <div class="flex flex-col sm:flex-row items-center sm:items-center space-y-3 sm:space-y-0 sm:space-x-4">
                        ...
                        <div class="text-center sm:text-left">
                            <h1 class="text-lg sm:text-xl lg:text-2xl font-bold text-gray-800">Detail Aset Tetap Lainnya</h1>
                    ...
                    <div class="text-center sm:text-right">
                        ...
                        <div class="text-lg sm:text-xl font-bold text-gray-800">{{ $asetTetapLainnya->id }}</div>
                    ...
                    <div class="bg-white rounded-lg shadow-md p-4 sm:p-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                            <div>
                                ...
                                <p class="mt-1 text-sm sm:text-base text-gray-800">{{ $asetTetapLainnya->nama_barang ?? '-' }}</p>
                            </div>
                            <div>
                                <label class="block text-xs sm:text-sm font-medium text-gray-600">Kode Barang</label>
                                <p class="mt-1 text-sm sm:text-base text-gray-800">{{ $asetTetapLainnya->kode_barang ?? '-' }}</p>
                            </div>
                            <div>
                                <label class="block text-xs sm:text-sm font-medium text-gray-600">Register</label>
                                <p class="mt-1 text-sm sm:text-base text-gray-800">{{ $asetTetapLainnya->register ?? '-' }}</p>
                            </div>
                            <div>
                                <label class="block text-xs sm:text-sm font-medium text-gray-600">Kondisi</label>
                                <p class="mt-1 text-sm sm:text-base text-gray-800">{{ $asetTetapLainnya->kondisi ?? '-' }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md p-4 sm:p-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                            <div>
                                ...
                                <p class="mt-1 text-sm sm:text-base text-gray-800 font-mono">{{ $asetTetapLainnya->kode_lokasi ?? '-' }}</p>
                            </div>
                            <div>
                                <label class="block text-xs sm:text-sm font-medium text-gray-600">Wilayah</label>
                                <p class="mt-1 text-sm sm:text-base text-gray-800">{{ $asetTetapLainnya->wilayah->wilayah ?? '-' }}</p>
                            </div>
                            <div>
                                <label class="block text-xs sm:text-sm font-medium text-gray-600">Bidang</label>
                                <p class="mt-1 text-sm sm:text-base text-gray-800">{{ $asetTetapLainnya->subBidang->bidang->bidang ?? '-' }}</p>
                            </div>
                            <div>
                                <label class="block text-xs sm:text-sm font-medium text-gray-600">Sub Bidang</label>
                                <p class="mt-1 text-sm sm:text-base text-gray-800">{{ $asetTetapLainnya->subBidang->sub_bidang ?? '-' }}</p>
                            </div>
                            <div>
                                <label class="block text-xs sm:text-sm font-medium text-gray-600">Unit</label>
                                <p class="mt-1 text-sm sm:text-base text-gray-800">{{ $asetTetapLainnya->unit->unit ?? '-' }}</p>
                            </div>
                            <div>
                                <label class="block text-xs sm:text-sm font-medium text-gray-600">Tahun Penempatan</label>
                                <p class="mt-1 text-sm sm:text-base text-gray-800">{{ $asetTetapLainnya->tahun ?? '-' }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md p-4 sm:p-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                            <div>
                                ...
                                <p class="mt-1 text-sm sm:text-base text-gray-800">{{ $asetTetapLainnya->subSubKelompok->sub_sub_kelompok ?? '-' }}</p>
                            </div>
                            <div>
                                <label class="block text-xs sm:text-sm font-medium text-gray-600">Tanggal Pengadaan</label>
                                <p class="mt-1 text-sm sm:text-base text-gray-800">{{ $asetTetapLainnya->tanggal_pengadaan ? \Carbon\Carbon::parse($asetTetapLainnya->tanggal_pengadaan)->format('d/m/Y') : '-' }}</p>
                            </div>
                            <div>
                                <label class="block text-xs sm:text-sm font-medium text-gray-600">Asal Usul</label>
                                <p class="mt-1 text-sm sm:text-base text-gray-800">{{ $asetTetapLainnya->asal_usul ?? '-' }}</p>
                            </div>
                            <div>
                                <label class="block text-xs sm:text-sm font-medium text-gray-600">Harga</label>
                                <p class="mt-1 text-sm sm:text-base text-gray-800">{{ $asetTetapLainnya->harga ? 'Rp ' . number_format($asetTetapLainnya->harga, 0, ',', '.') : '-' }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md p-4 sm:p-6">
                        ...
                        <div class="space-y-3 sm:space-y-4">
                            <div>
                                ...
                                <p class="mt-1 text-sm sm:text-base text-gray-800">{{ $asetTetapLainnya->keterangan ?? '-' }}</p>
                            </div>
                            <div>
                                <label class="block text-xs sm:text-sm font-medium text-gray-600">Dokumentasi</label>
                                <p class="mt-1 text-sm sm:text-base text-gray-800">{{ $asetTetapLainnya->dokumentasi ?? '-' }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md p-4 sm:p-6">
                        ...
                        <div class="space-y-2 text-xs sm:text-sm">
                            <div>
                                ...
                                <span class="text-gray-800 block sm:inline">{{ $asetTetapLainnya->created_at ? \Carbon\Carbon::parse($asetTetapLainnya->created_at)->format('d/m/Y H:i') : '-' }}</span>
                            </div>
                            <div>
                                <span class="text-gray-600">Diubah pada:</span>
                                <span class="text-gray-800 block sm:inline">{{ $asetTetapLainnya->updated_at ? \Carbon\Carbon::parse($asetTetapLainnya->updated_at)->format('d/m/Y H:i') : '-' }}</span>
                            </div>
                            <div>
                                <span class="text-gray-600">User:</span>
                                <span class="text-gray-800 block sm:inline">{{ $asetTetapLainnya->user ?? '-' }}</span>
                            </div>
                        </div>
                    </div>
                </div>
