...
<head>
    ...
    <title>Detail Jalan, Irigasi & Jaringan - {{ $jaringan->id }}</title>
                ...
                <div class="flex flex-col sm:flex-row items-center sm:items-start justify-between space-y-4 sm:space-y-0">
                    <div class="flex flex-col sm:flex-row items-center sm:items-center space-y-3 sm:space-y-0 sm:space-x-4">
                        ...
                        <div class="text-center sm:text-left">
                            <h1 class="text-lg sm:text-xl lg:text-2xl font-bold text-gray-800">Detail Jalan, Irigasi & Jaringan</h1>
                    ...
                    <div class="text-center sm:text-right">
                        ...
                        <div class="text-lg sm:text-xl font-bold text-gray-800">{{ $jaringan->id }}</div>
                    ...
                    <div class="bg-white rounded-lg shadow-md p-4 sm:p-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                            <div>
                                ...
                                <p class="mt-1 text-sm sm:text-base text-gray-800">{{ $jaringan->nama_barang ?? '-' }}</p>
                            </div>
                            <div>
                                <label class="block text-xs sm:text-sm font-medium text-gray-600">Kode Barang</label>
                                <p class="mt-1 text-sm sm:text-base text-gray-800">{{ $jaringan->kode_barang ?? '-' }}</p>
                            </div>
                            <div>
                                <label class="block text-xs sm:text-sm font-medium text-gray-600">Register</label>
                                <p class="mt-1 text-sm sm:text-base text-gray-800">{{ $jaringan->register ?? '-' }}</p>
                            </div>
                            <div>
                                <label class="block text-xs sm:text-sm font-medium text-gray-600">Konstruksi</label>
                                <p class="mt-1 text-sm sm:text-base text-gray-800">{{ $jaringan->konstruksi ?? '-' }}</p>
                            </div>
                            <div>
                                <label class="block text-xs sm:text-sm font-medium text-gray-600">Panjang (m)</label>
                                <p class="mt-1 text-sm sm:text-base text-gray-800">{{ $jaringan->panjang ?? '-' }}</p>
                            </div>
                            <div>
                                <label class="block text-xs sm:text-sm font-medium text-gray-600">Lebar (m)</label>
                                <p class="mt-1 text-sm sm:text-base text-gray-800">{{ $jaringan->lebar ?? '-' }}</p>
                            </div>
                            <div>
                                <label class="block text-xs sm:text-sm font-medium text-gray-600">Luas (m²)</label>
                                <p class="mt-1 text-sm sm:text-base text-gray-800">{{ $jaringan->luas ?? '-' }}</p>
                            </div>
                            <div>
                                <label class="block text-xs sm:text-sm font-medium text-gray-600">Kondisi</label>
                                <p class="mt-1 text-sm sm:text-base text-gray-800">{{ $jaringan->kondisi ?? '-' }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md p-4 sm:p-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                            <div>
                                ...
                                <p class="mt-1 text-sm sm:text-base text-gray-800 font-mono">{{ $jaringan->kode_lokasi ?? '-' }}</p>
                            </div>
                            <div>
                                <label class="block text-xs sm:text-sm font-medium text-gray-600">Wilayah</label>
                                <p class="mt-1 text-sm sm:text-base text-gray-800">{{ $jaringan->wilayah->wilayah ?? '-' }}</p>
                            </div>
                            <div>
                                <label class="block text-xs sm:text-sm font-medium text-gray-600">Bidang</label>
                                <p class="mt-1 text-sm sm:text-base text-gray-800">{{ $jaringan->subBidang->bidang->bidang ?? '-' }}</p>
                            </div>
                            <div>
                                <label class="block text-xs sm:text-sm font-medium text-gray-600">Sub Bidang</label>
                                <p class="mt-1 text-sm sm:text-base text-gray-800">{{ $jaringan->subBidang->sub_bidang ?? '-' }}</p>
                            </div>
                            <div>
                                <label class="block text-xs sm:text-sm font-medium text-gray-600">Unit</label>
                                <p class="mt-1 text-sm sm:text-base text-gray-800">{{ $jaringan->unit->unit ?? '-' }}</p>
                            </div>
                            <div>
                                <label class="block text-xs sm:text-sm font-medium text-gray-600">Tahun Penempatan</label>
                                <p class="mt-1 text-sm sm:text-base text-gray-800">{{ $jaringan->tahun ?? '-' }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md p-4 sm:p-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                            <div>
                                ...
                                <p class="mt-1 text-sm sm:text-base text-gray-800">{{ $jaringan->subSubKelompok->sub_sub_kelompok ?? '-' }}</p>
                            </div>
                            <div>
                                <label class="block text-xs sm:text-sm font-medium text-gray-600">Tanggal Pengadaan</label>
                                <p class="mt-1 text-sm sm:text-base text-gray-800">{{ $jaringan->tanggal_pengadaan ? \Carbon\Carbon::parse($jaringan->tanggal_pengadaan)->format('d/m/Y') : '-' }}</p>
                            </div>
                            <div>
                                <label class="block text-xs sm:text-sm font-medium text-gray-600">Asal Usul</label>
                                <p class="mt-1 text-sm sm:text-base text-gray-800">{{ $jaringan->asal_usul ?? '-' }}</p>
                            </div>
                            <div>
                                <label class="block text-xs sm:text-sm font-medium text-gray-600">Harga</label>
                                <p class="mt-1 text-sm sm:text-base text-gray-800">{{ $jaringan->harga ? 'Rp ' . number_format($jaringan->harga, 0, ',', '.') : '-' }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md p-4 sm:p-6">
                        ...
                        <div class="space-y-3 sm:space-y-4">
                            <div>
                                ...
                                <p class="mt-1 text-sm sm:text-base text-gray-800">{{ $jaringan->keterangan ?? '-' }}</p>
                            </div>
                            <div>
                                <label class="block text-xs sm:text-sm font-medium text-gray-600">Dokumentasi</label>
                                <p class="mt-1 text-sm sm:text-base text-gray-800">{{ $jaringan->dokumentasi ?? '-' }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md p-4 sm:p-6">
                        ...
                        <div class="space-y-2 text-xs sm:text-sm">
                            <div>
                                ...
                                <span class="text-gray-800 block sm:inline">{{ $jaringan->created_at ? \Carbon\Carbon::parse($jaringan->created_at)->format('d/m/Y H:i') : '-' }}</span>
                            </div>
                            <div>
                                <span class="text-gray-600">Diubah pada:</span>
                                <span class="text-gray-800 block sm:inline">{{ $jaringan->updated_at ? \Carbon\Carbon::parse($jaringan->updated_at)->format('d/m/Y H:i') : '-' }}</span>
                            </div>
                            <div>
                                <span class="text-gray-600">User:</span>
                                <span class="text-gray-800 block sm:inline">{{ $jaringan->user ?? '-' }}</span>
                            </div>
                        </div>
                    </div>
                </div>
