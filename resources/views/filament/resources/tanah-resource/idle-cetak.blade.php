...
<div class="container-fluid">
    ...
    <div class="text-center my-3">
        ...
        <div class="title mt-1">DAFTAR TANAH IDLE</div>
    </div>
    ...
    <table class="table table-bordered mb-1" style="font-size: 10px;">
        ...
        <tr>
            ...
            <th rowspan="2" style="width: 120px; text-align: center;">NAMA BARANG/<br>JENIS BARANG</th>
            <th colspan="2" style="width: 100px; text-align: center;">NOMOR</th>
            <th rowspan="2" style="width: 60px; text-align: center;">LUAS<br>(M2)</th>
            ...
            <th rowspan="2" style="width: 60px; text-align: center;">HAK</th>
            <th colspan="2" style="width: 120px; text-align: center;">SERTIFIKAT</th>
            <th rowspan="2" style="width: 80px; text-align: center;">PENGGUNAAN</th>
            <th rowspan="2" style="width: 80px; text-align: center;">ASAL-USUL<br>PEROLEHAN</th>
            <th colspan="2" style="width: 100px; text-align: center;">MASA BERLAKU</th>
            <th rowspan="2" style="width: 80px; text-align: center;">HARGA PEMBELIAN<br>(RP.)</th>
            <th colspan="2" style="width: 60px; text-align: center;">KONDISI</th>
        ...
        <tr>
            ...
            <th style="width: 60px; text-align: center;">NOMOR</th>
            <th style="width: 50px; text-align: center;">JANGKA<br>WAKTU</th>
            <th style="width: 50px; text-align: center;">TAHUN<br>BERAKHIR</th>
        ...
        @if($data->count() > 0)
            @foreach($data as $i => $item)
                <tr>
                    ...
                    <td class="text-center">{{ $item->kondisi == 'Tidak Baik' ? '✓' : '' }}</td>
                    <td>{{ $item->user ?? '-' }}</td>
        ...
        @else
            <tr>
                <td colspan="21" class="text-center">Tidak ada data tanah idle</td>
            </tr>
        @endif
        </tbody>
    </table>
    
    <div class="text-end me-2">(QR-AST.PA/01-09)</div>
    ...
    <div class="signature-section">
        <div class="row">
            ...
            <div class="col-6 text-center">
                ...
                <div class="mb-2">Staf Pendayagunaan Aset</div>
                <div style="height: 60px;"></div>
